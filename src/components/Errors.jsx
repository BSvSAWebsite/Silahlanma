...
const Error = () => {
  return (
    <div className='h-screen bg-black w-full flex flex-col gap-2 justify-center items-center'>
      ...
      <Link to='/' className='text-red-800 border-2 border-red-600 rounded-lg text-3xl py-1 px-3 hover:text-green-400 hover:border-green-300 duration-300'>Go Back</Link>
    </div>
  )
}
